...
const Textarea = forwardRef(({ className, rows = 4, ...props }, ref) => {
  return (
    <textarea
      ...
      rows={rows}
      className={cn(
        "min-h-24 w-full rounded-[10px] border border-[color:rgb(var(--ui-border)/0.28)] bg-[rgb(var(--bg-muted)/0.9)] px-3 py-2 text-sm text-[rgb(var(--text-base))] placeholder:text-[rgb(var(--text-muted))]",
